...
class Configurator {
	 ...
	 *
	 * @param object $target
	 *        	The object that needs to be configured.
	 * @param \Traversable $options
	 *        	The configuration to apply. Traversable is amongst
	 *        	others implemented by Zend\Config and arrays
	 * @param boolean $tryCall
	 *        	When true and $target has a __call() function, try call if no setter is available.
	 * @return void Nothing
	 *        
	 */
